...
CONFIG_FASES = {
    ...
    2: {"fps":  10, "chance_bomba": 0.25, "tempo_item": 5000, "musica": "8bit Bossa.mp3", "meta_vidas": 2, "meta_score": 70},
    3: {"fps":  12, "chance_bomba": 0.35, "tempo_item": 4500, "musica": "2012_november_fakeAwake04 back to A minor.wav", "meta_vidas": 3, "meta_score": 90},
    4: {"fps":  14, "chance_bomba": 0.45, "tempo_item": 4000, "musica": "fight_looped.wav", "meta_vidas": 4, "meta_score": 110},
    5: {"fps": 16, "chance_bomba": 0.60, "tempo_item": 5000, "musica": "Orbital Colossus.mp3","meta_vidas": None, "meta_score": None}  # Fase final não possui metas de avanço
}
...
try:
    ...
    print("[Aviso] Fundo.png não encontrado.")
    usa_fundo = False
